...
export default function FlavorSelector({
  ...
  useEffect(() => {
    if (selectedId !== null) {
      ...
      const price = flavor?.price ?? 0;

      setSelectedPrice(price);

      if (onFlavorChange) {
        onFlavorChange(selectedId, price);
      }
    } else {
      setSelectedPrice(0);
        ...
        {activeFlavors.map((flavor) => {
          ...
          return (
            <button
              ...
              type="button"
              onClick={() =>
                !isOutOfStock && handleSelect(flavor.id)
              }
            ...
            >
              ...
              {flavor.price !== null && flavor.price > 0 && (
