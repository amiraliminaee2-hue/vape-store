        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-gray-50 rounded-xl p-4 text-center">
              ...
              <span
                className={`inline-block px-3 py-1 rounded-full text-xs mt-1 ${statusInfo.color}`}
              >
                {statusInfo.label}
              </span>
            </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-100">
                  <th className="text-right py-3 px-4 rounded-tr-xl">
                    محصول
                  </th>
                  ...
                  <th className="text-left py-3 px-4 rounded-tl-xl">
                    مجموع
                  </th>
                </tr>
              </thead>
              ...
              <div className="w-full md:w-80 space-y-3">
                ...
                {data.shippingCost >
                  ...
                  <div className="flex justify-between py-2">
                    ...
                    <span>
                      {data.shippingCost.toLocaleString(
                        "fa-IR"
                      )}{" "}
                      تومان
                    </span>
